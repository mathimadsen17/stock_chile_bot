...
from lector.paris import disponibilidad_PS5_paris
...
from digitales.microplay_digital import disponibilidad_PS5_microplay_digital
...
while True:
    ...
    disponibilidad_PS5_paris(datos.link_paris_lector)
    ...
    disponibilidad_PS5_microplay_digital(datos.link_microplay_digital)
