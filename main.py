...
while True:
    disponibilidad_PS5_falabella(
        "https://www.falabella.com/falabella-cl/product/prod37699550/COMBO-PLAYSTATION-5-+-JGO-SPIDER-MAN/sku37700168"
    )
    disponibilidad_PS5_lider("https://www.lider.cl/catalogo/product/sku/1000000000359")
    if (
        disponibilidad_PS5_mercadolibre(
            "https://articulo.mercadolibre.cl/MLC-613490868-playstation-5-ps5-estandar-spider-man-miles-morales-_JM"
        )
        == True
    ):
        telegram_bot_sendtext_checker(
            "HAY STOCK DISPONIBLE DE PS5 CON LECTOR EN MERCADO LIBRE https://articulo.mercadolibre.cl/MLC-613490868-playstation-5-ps5-estandar-spider-man-miles-morales-_JM"
        )
    ...
    disponibilidad_PS5_pcfactory(
        "https://www.pcfactory.cl/producto/43431-sony-consola-playstation-5"
    )
    ...
    disponiblidad_PS5_digital_lapolar(
        "https://www.lapolar.cl/consola-sony-playstation-5-digital/23395657.html"
    )
    disponibilidad_PS5_digital_ripley(
        "https://simple.ripley.cl/consola-ps5-digital-edition-2000380458314p?color_80=blanco&s=o"
    )
    disponibilidad_PS5_digital_pcfactory(
        "https://www.pcfactory.cl/producto/42732-sony-consola-playstation-5-version-all-digital--3-meses-playstation-plus"
    )
...
if __name__ == "__main__":
    ...
    listado = {}
    for tienda, datos in enlaces.enlaces.items():
        url, args, kw_args = datos
        revisor = scanner.Scanner(tienda, url, *args, **kw_args)
        revisor.inicia()
        listado[tienda] = revisor
